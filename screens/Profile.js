        ...
        <>
            <ScrollView style={styles.container}>
                ...
                <View style={{ borderBottomColor: 'black', borderWidth: 1, padding: 7, flexDirection: 'row', justifyContent: 'space-between', }}>
                    <TextInput placeholder="John Doe" value={name} onChangeText={(value) => setname(value)} />
                ...
                <View style={{ borderBottomColor: 'black', borderWidth: 1, padding: 7, flexDirection: 'row', justifyContent: 'space-between' }}>
                    <TextInput placeholder="someone@example.com" value={email} onChangeText={(value) => setemail(value)} />
