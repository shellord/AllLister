...
const ProductFlatList = ({navigation}) => {
  const renderItem = ({ item }) => (
    <ProductScroll navigation={navigation} id={item.id} shopName={item.shopName} title={item.title} imageUri={item.imageUri} category={item.category} price={item.price} description={item.description}/>
  );
